...
{
    { "WM8962_CODEC_DIAGS_MODE_NORMAL                 ", WM8962_CODEC_DIAGS_MODE_NORMAL                  }, 
    { "WM8962_CODEC_DIAGS_MODE_AUTOMATED_SPEAKER_TEST ", WM8962_CODEC_DIAGS_MODE_AUTOMATED_SPEAKER_TEST  },
    { "WM8962_CODEC_DIAGS_MODE_LEFT_HP_TEST           ", WM8962_CODEC_DIAGS_MODE_LEFT_HP_TEST            },
    { "WM8962_CODEC_DIAGS_MODE_RIGHT_HP_TEST          ", WM8962_CODEC_DIAGS_MODE_RIGHT_HP_TEST           },
    { "WM8962_CODEC_DIAGS_MODE_BOTH_HP_TEST           ", WM8962_CODEC_DIAGS_MODE_BOTH_HP_TEST            },
    { "WM8962_CODEC_DIAGS_MODE_LEFT_SP_TEST           ", WM8962_CODEC_DIAGS_MODE_LEFT_SP_TEST            },
    { "WM8962_CODEC_DIAGS_MODE_RIGHT_SP_TEST          ", WM8962_CODEC_DIAGS_MODE_RIGHT_SP_TEST           },
    { "WM8962_CODEC_DIAGS_MODE_BOTH_SP_TEST           ", WM8962_CODEC_DIAGS_MODE_BOTH_SP_TEST            },
    { "WM8962_CODEC_DIAGS_MODE_MIC_TEST               ", WM8962_CODEC_DIAGS_MODE_MIC_TEST                },
		    ...
		    struct snd_kcontrol *kcontrol, int event)
{
    ...
    case WM8962_CODEC_DIAGS_MODE_NORMAL:
        break;
    case WM8962_CODEC_DIAGS_MODE_AUTOMATED_SPEAKER_TEST:
        dev_err(codec->dev, "%s: Do nothing in automated speaker test\n", __func__);
        return 0;
    }
	switch (event) {
	case SND_SOC_DAPM_POST_PMU:
		...
		if ((reg & expected) != expected)
			...
			dev_err(codec->dev, "%s: DC servo complete after %dms\n", __func__,
				timeout);
			 ...
			 struct snd_kcontrol *kcontrol, int event)
{
	...
	case WM8962_HPOUTR_PGA_ENA_SHIFT:
        ...
        if (wm8962_codec_diags_mode) 
        {
             ...
             */
            printk(KERN_WARNING "%s: WM8962_HPOUTR_VOLUME, do nothing\n", __func__);
            return 0;
        }
				if (!headset_detected)
					return 0;
	...
	case WM8962_HPOUTL_PGA_ENA_SHIFT:
        ...
        if (wm8962_codec_diags_mode) 
        {
             ...
             * Ignore head phone volume in automated speakers test mode
             */
            printk(KERN_WARNING "%s: WM8962_HPOUTL_VOLUME, do nothing\n", __func__);
            return 0;
        }
				if (!headset_detected)
					return 0;
	...
	case WM8962_SPKOUTR_PGA_ENA_SHIFT:
        ...
        printk(KERN_WARNING "%s: WM8962_SPKOUTR_VOLUME reg: %d 0x%02X\n", 
               __func__, reg, reg);
				if (wm8962_codec_diags_mode)
	...
	case WM8962_SPKOUTL_PGA_ENA_SHIFT:
        ...
        printk(KERN_WARNING "%s: WM8962_SPKOUTL_VOLUME reg: %d 0x%02X\n", 
               __func__, reg, reg);
				if (wm8962_codec_diags_mode)
					reg_cache[reg] = WM8962_DIAGS_SPKR_VOL;
				else if (headset_detected)
...
//	printk(KERN_WARNING "wm8962_hw_params, rate: %d\n", rate);
